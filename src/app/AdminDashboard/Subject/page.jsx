    ...
    <>
      <div className="h-screen w-full flex flex-col gap-6 p-5">
        ...
        <div className="w-full flex items-center justify-between">
          <h1 className="text-base font-medium">Total Subject: {totalCourses}</h1>
          <div className="flex items-center justify-center gap-5">
            <Link href={"/AdminDashboard/Subject/AddSubject"}>
        ...
        <div className="h-auto w-full flex flex-col rounded-lg  border border-gray-300">
          ...
          <div className="flex flex-col">
            <SubjectTable filter={filter} searchTerm={searchTerm} />
          </div>
        </div>
      </div>
    </>
