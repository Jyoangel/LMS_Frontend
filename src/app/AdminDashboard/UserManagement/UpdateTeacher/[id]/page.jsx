...
import { fetchTeacherById, updateTeacherData } from '../../../../../../api/teacherapi'; // api to fetch and update specific teacher using id 
...
const UpdateTeacher = ({ params }) => {
    ...
    // use to call api to fetch teacher 
    useEffect(() => {
    ...
    // use to update specific teacher 
    ...
    return (
        <div className="h-screen w-full flex flex-col px-5 py-10 gap-10">
            ...
            {/* Success Modal */}
            {isSelectOpen && (
                <Successcard onClose={closeModal} para={"Teacher updated successfully!"} url={"/AdminDashboard/UserManagement"} />
            )}
        </div>
    );
};
