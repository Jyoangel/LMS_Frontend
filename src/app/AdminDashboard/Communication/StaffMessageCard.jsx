...
import { sendMessages, sendSMS } from "../../../../api/staffapi"; // api to send message through emal ns phonenumber
import Successcard from "@/Components/Successcard";

export default function StaffMessageCard({ onClose, selectedStaff }) {
    ...
    const handleSend = async () => {
        ...
        try {
            await sendMessages(subject, message, selectedStaff);
