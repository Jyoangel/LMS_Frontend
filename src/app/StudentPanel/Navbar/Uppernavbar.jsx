    ...
    <div className="relative h-20 w-full bg-white px-10 flex items-center justify-between shadow-lg">
      ...
      <div className="flex gap-5 items-center justify-center relative">
        ...
        {dropdownVisible && (
          ...
          >
            <a href="/api/auth/auth0?action=logout" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
              Logout
            </a>
          </div>
        )}
  ...
  return (
    <>
      <div className="h-20 w-full bg-white px-10 flex items-center justify-between shadow-lg">
        <h1 className="text-xl font-medium">Welcome Kamlesh Kumar!</h1>
        <div className="flex gap-5 items-center justify-center">
          <Image src={noti} />
          <Image src={person1} />
          <h1 className="text-xl font-medium">Kamlesh Kumar</h1>
